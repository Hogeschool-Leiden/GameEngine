...
public interface Helpers {
    static BoundingBox toBoundingBox(Vector location, Dimension dimension) {
        return new BoundingBox(location, dimension);
    }

    static void drawBoundingBoxes(Collection<BoundingBox> boundingBoxes, Graphics graphics) {
